...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	bloodPos =  {x = toPosition.x, y = toPosition.y, z = toPosition.z, stackpos = 1}
	bloodSpot = getThingfromPos(bloodPos)
	if item.type == 2 and itemEx.uid == 2405 and getPlayerStorageValue(cid,2405) == -1 then -- Cemetary Mansion Vamp Statue 1
		doSendMagicEffect(toPosition, 9)
		setPlayerStorageValue(cid,2405,1)
	elseif item.type == 2 and itemEx.uid == 2406 and getPlayerStorageValue(cid,2406) == -1 then -- Cemetary Mansion Vamp Statue 2
		doSendMagicEffect(toPosition, 9)
		setPlayerStorageValue(cid,2406,1)
	elseif item.type == 2 and itemEx.uid == 2407 and getPlayerStorageValue(cid,2407) == -1 then -- Cemetary Mansion Vamp Statue 3
		doSendMagicEffect(toPosition, 9)
		setPlayerStorageValue(cid,2412,1)
	end
	...
	elseif (bloodSpot.itemid >= 2016 and bloodSpot.itemid <= 2021) or (bloodSpot.itemid >= 2025 and bloodSpot.itemid <= 2030) and bloodSpot.type == 2 then
