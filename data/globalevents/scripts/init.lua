...
function onStartup()
	setGlobalStorageValue(2378,-1) -- Reset Brother Daniel Spawn
	setGlobalStorageValue(2391,-1) -- Task - Lump Timer
	setGlobalStorageValue(2392,-1) -- Task - Glorgor Timer
	setGlobalStorageValue(2393,-1) -- Task - Scat Timer
	setGlobalStorageValue(2394,-1) -- Task - Puff Timer
	setGlobalStorageValue(2395,-1) -- Task - Udder Timer
	setGlobalStorageValue(2396,-1) -- Task - Esmeralda Timer
	setGlobalStorageValue(2397,-1) -- Task - Barney Timer
	setGlobalStorageValue(2398,-1) -- Task - Hero Timer
	setGlobalStorageValue(2399,-1) -- Task - Hydra Timer
	setGlobalStorageValue(2424,-1) -- Task - Demon Timer
	setGlobalStorageValue(2425,-1) -- Task - Draken Timer
	setGlobalStorageValue(2614,-1) -- Task - Bog Raider Timer
	setGlobalStorageValue(2482,-1) -- DHQ Switch Lever Event
