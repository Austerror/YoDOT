...
function creatureSayCallback(cid, type, msg)
	...
	local shopWindow = {}
	local t = {
		[2003] = {price = 1}, -- [ITEMID TO SELL] = {HOW TO COST}
		[2004] = {price = 1},
		[2365] = {price = 3},
		[3940] = {price = 1},
		[5801] = {price = 2},
	...
	if msgcontains(msg, 'other') then
		npcHandler:say('I also provide the following items: {change sex} - 1 token, {nobleman addons} - 2 Tokens, {crimson ray mount} - 5 tokens.', cid)
